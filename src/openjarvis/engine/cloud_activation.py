"""Pure helpers for credential-driven cloud-engine activation.
...
def active_server_cloud_credentials(
    ...
    The returned tuple is sorted for deterministic diagnostics. Values are
    intentionally neither returned nor transformed.
    """
